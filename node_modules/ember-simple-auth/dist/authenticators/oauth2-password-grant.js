...
import isFastBoot from '../utils/is-fastboot.js';
...
/**
  ...
  @public
*/
var oauth2PasswordGrant = BaseAuthenticator.extend({
  /**
    ...
    return new RSVP.Promise((resolve, reject) => {
      ...
      if (!isEmpty(data['expires_at']) && data['expires_at'] < now) {
        if (refreshAccessTokens) {
          this._refreshAccessToken(data['expires_in'], data['refresh_token'], data['scope']).then(resolve, reject);
        } else {
          reject();
        }
      } else {
...
export { oauth2PasswordGrant as default };
//# sourceMappingURL=oauth2-password-grant.js.map
