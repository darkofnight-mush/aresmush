...
import { isEmpty, typeOf, isPresent, isNone } from '@ember/utils';
import { A } from '@ember/array';
import { getOwner } from '@ember/application';
import { warn } from '@ember/debug';
import BaseStore from './base.js';
import objectsAreEqual from '../utils/objects-are-equal.js';
  ...
  */
  ...
  cookieExpirationTime: persistingProperty(function (key, value) {
    ...
    if (isNone(value)) {
      ...
      warn('The recommended minimum value for `cookieExpirationTime` is 90 seconds. If your value is less than that, the cookie may expire before its expiration time is extended (expiration time is extended every 60 seconds).', false, {
        id: 'ember-simple-auth.cookieExpirationTime'
      });
    }
  }),
  _cookies: inject('cookies'),
  _secureCookies() {
