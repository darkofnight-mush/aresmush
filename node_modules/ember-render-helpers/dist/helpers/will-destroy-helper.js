 ...
 */
class WillDestroyHelperHelper extends Helper {
  callback;
  named;
  positional;
  compute(positional, named) {
    const [callback, ...positionalParameters] = positional;
    assert(`\`{{will-destroy-helper}}\` expects a function as the first parameter. You provided: ${callback}`, typeof callback === 'function');
...
export { WillDestroyHelperHelper as default };
//# sourceMappingURL=will-destroy-helper.js.map
